...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://mnj9k12qa6.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.hw2yl9822Options = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var hw2yl9822OptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/hw2yl9822').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(hw2yl9822OptionsRequest, authType, additionalParams, config.apiKey);
    };
